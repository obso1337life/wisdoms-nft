...
const Loader = props => {
    ...
    // setInterval(() => {
    //     console.log('!!active, progress, errors, item, loaded, total', active, progress, errors, item, loaded, total);
    // }, 10)
    console.log('ahhh');
...
const Objet = props => {
    ...
    return (
        // <Suspense fallback={<Loader setLoadingStatus={setLoadingStatus} />}>
            <group
                position={[0, 0, 0]}
            >
                <Cone
